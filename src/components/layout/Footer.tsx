...
export default function Footer({
  ...
  description = "Profesionales dedicados a tu bienestar emocional. Te acompanamos en cada paso de tu camino hacia una vida mas plena y equilibrada.",
  ...
  socialFacebook = "",
  socialLinkedin = "",
  copyrightText = "(c) 2026 Vital Emocion. Todos los derechos reservados.",
}: FooterProps) {
